...
for(let boton of btn_compra){
    ...
    boton.addEventListener("click", function(){
        Toastify({
            text:"Se ha agregado un nuevo servicio/producto al carrito", 
            duration:2500,
